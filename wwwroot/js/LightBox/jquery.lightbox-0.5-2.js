    ...
    */
    $.fn.lightBox = function (settings) {
        ...
        settings = jQuery.extend({
            ...
            imageBtnPrev: '../JS/LightBox/btn_prev.png', 		// (string) Path and the name of the prev button image
            imageBtnNext: '../JS/LightBox/btn_next.png', 		// (string) Path and the name of the next button image
            imageBtnClose: '../JS/LightBox/closebutton.png', 	// (string) Path and the name of the close btn
